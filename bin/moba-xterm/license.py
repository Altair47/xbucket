...
def GenerateLicense(Type : LicenseType, Count : int, UserName : str, MajorVersion : int, MinorVersion, Path='Custom.mxtpro'):
    assert(Count >= 0)
...
if __name__ == '__main__':
    if len(sys.argv) != 3:
        ...
        LicensePath = os.path.expanduser('~') + '\\AppData\\Local\\Temp\\Custom.mxtpro'
